//go:build kind
// +build kind
// This file is used for running operator locally and connect to Kind cluster via exposed NodePorts
...
func servicePerPodPorts(i int) []v1.ServicePort {
	return []corev1.ServicePort{
		{
			Name:       "hazelcast-port",
			Protocol:   corev1.ProtocolTCP,
