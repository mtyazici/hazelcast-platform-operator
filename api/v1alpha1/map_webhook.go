...
func (r *Map) SetupWebhookWithManager(mgr ctrl.Manager) error {
...
func (r *Map) ValidateCreate() error {
	maplog.Info("validate create", "name", r.Name)
...
func (r *Map) ValidateUpdate(old runtime.Object) error {
	maplog.Info("validate update", "name", r.Name)
...
func (r *Map) ValidateDelete() error {
	maplog.Info("validate delete", "name", r.Name)
